...
public class WaterMonsterTest {
    ...
    @Test
    public void isAlive_confirmsWaterMonsterIsAliveIfAllLevelAboveMinimum_true(){
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
        assertEquals(testWaterMonster.isAlive(),true);
    }
    @Test
    public void depleteLevel_reducesAllLevels(){
        WaterMonster testWaterMonster = new WaterMonster("Bubles",1);
    ...
    @Test
    public void isAlive_recognizesWaterMonsterIsDeadWhenLevelIsReachMinimum_false(){
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
    ...
    @Test
    public void plat_increasesWaterMonsterPlayLevel(){
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
    ...
    @Test
    public void feed_increasesWaterMonstersFoodLevel(){
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
    ...
    public void feed_throwsExceptionIfPlayLevelIsAtMaxValue(){
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
    ...
    public void timer_executesDepleteLevelsMethod() {
        ...
        try {
            ...
            int secondPlayLevel = testWaterMonster.getPlayLevel();assertTrue(firstPlayLevel > secondPlayLevel);
    }
    @Test
    public void timer_haltsAfterWaterMonsterDies() {
        WaterMonster testWaterMonster = new WaterMonster("Bubbles",1);
        testWaterMonster.startTimer(); try {
            Thread.sleep(6000);
        } catch (InterruptedException exception){}
