...
public class FireMonsterTest {
    ...
    @Test
    public void isAlive_confirmsFireMonsterIsAliveIfAllLevelAboveMinimum_true(){
        FireMonster testFireMonster = new FireMonster("Bubbles",1);
        assertEquals(testFireMonster.isAlive(),true);
    }
    @Test
    public void depleteLevel_reducesAllLevels(){
        FireMonster testFireMonster = new FireMonster("Bubles",1);
    ...
    @Test
    public void isAlive_recognizesFireMonsterIsDeadWhenLevelIsReachMinimum_false(){
        FireMonster testFireMonster = new FireMonster("Bubbles",1);
    ...
    @Test
    public void plat_increasesFireMonsterPlayLevel(){
        FireMonster testFireMonster = new FireMonster("Bubbles",1);
    ...
    @Test
    public void feed_increasesFireMonstersFoodLevel(){
        FireMonster testFireMonster = new FireMonster("Bubbles",1);
    ...
    public void timer_executesDepleteLevelsMethod() {
        ...
        try {
            ...
            int secondPlayLevel = testFireMonster.getPlayLevel();assertTrue(firstPlayLevel > secondPlayLevel);
    }
    @Test
    public void timer_haltsAfterFireMonsterDies() {
        FireMonster testFireMonster = new FireMonster("Bubbles",1);
        testFireMonster.startTimer(); try {
            Thread.sleep(6000);
        } catch (InterruptedException exception){}
