...
public class MonsterTest {
    ...
    @Test
    public void isAlive_confirmsMonsterIsAliveIfAllLevelAboveMinimum_true(){
        Monster testMonster = new Monster("Bubbles",1);
        assertEquals(testMonster.isAlive(),true);
    }
    @Test
    public void depleteLevel_reducesAllLevels(){
        Monster testMonster = new Monster("Bubles",1);
    ...
    @Test
    public void isAlive_recognizesMonsterIsDeadWhenLevelIsReachMinimum_false(){
        Monster testMonster = new Monster("Bubbles",1);
    ...
    @Test
    public void plat_increasesMonsterPlayLevel(){
        Monster testMonster = new Monster("Bubbles",1);
        testMonster.play();
    ...
    @Test
    public void feed_increasesMonstersFoodLevel(){
        Monster testMonster = new Monster("Bubbles",1);
        testMonster.feed();
    ...
    public void timer_executesDepleteLevelsMethod() {
        ...
        try {
            ...
            int secondPlayLevel = testMonster.getPlayLevel();assertTrue(firstPlayLevel > secondPlayLevel);
    }
    @Test
    public void timer_haltsAfterMonsterDies() {
        Monster testMonster = new Monster("Bubbles",1);
        testMonster.startTimer(); try {
            Thread.sleep(6000);
        } catch (InterruptedException exception){}
